...
def parse_html(html):
    ...
    for info_dict in info_list:
        ...
        result_dict['uploadTime'] = common.timestamp_to_str(info_dict['date'] / 1000)[ : len('2017-03-25')]
...
def main():
    ...
    before_day = common.get_before_time(30)[ : len('2017-03-23')]
    today = common.get_current_time()[ : len('2017-03-23')]
